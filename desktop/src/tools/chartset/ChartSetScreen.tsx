...
export function ChartSetScreen({ projectId }: ChartSetScreenProps) {
  ...
  return (
    <Panel title="Pareto / Histogram / Run Chart + Scatter / Box">
      <Field label="Dataset" htmlFor="chartset-dataset">
        <SelectInput id="chartset-dataset" data-testid="chartset-dataset-select" value={datasetId} onChange={(e) => setDatasetId(e.target.value)}>
